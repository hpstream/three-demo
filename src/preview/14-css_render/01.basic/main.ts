...
let camera: THREE.PerspectiveCamera, scene: THREE.Scene, renderer: THREE.WebGLRenderer, labelRenderer;

const clock = new THREE.Clock();
const textureLoader = new THREE.TextureLoader();

let moon: THREE.Mesh, chinaLabel: CSS2DObject, earth: THREE.Mesh;
...
function animate() {
   ...
   moon.rotation.set(0, elapsed * 0.2, 0);
   // earth.rotation.set(0, elapsed * 0.2, 0);
