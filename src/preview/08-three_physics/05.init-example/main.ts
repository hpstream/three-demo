...
function render(time: number) {
  ...
  cubeArr.forEach((item) => {
    ...
    console.log(item.body.quaternion.x, item.body.quaternion.y, item.body.quaternion.z);


    item.mesh.quaternion.copy(new THREE.Quaternion(item.body.quaternion.x, item.body.quaternion.y, item.body.quaternion.z));
  })
