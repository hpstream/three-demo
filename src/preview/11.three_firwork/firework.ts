...
export default class Fireworks {
  ...
  fireworksMaterial: Three.ShaderMaterial;
  fireworks: Three.Points;
  linstener: Three.AudioListener;
  linstener1: Three.AudioListener;
  sound: Three.Audio;
  sendSound: Three.Audio;
  scene: Three.Scene;
  sendSoundplay: boolean;
  play: boolean;
  constructor(color: string, to, from = { x: 0, y: 0, z: 0 }) {
  ...
  //   添加到场景
  addScene(scene: Three.Scene, camera: Three.Camera) {
