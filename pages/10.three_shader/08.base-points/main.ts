...
console.log(basicVertexShader, basicFragmentShader);
...
const texture = textureLoader.load('./particles/10.png');
const texture1 = textureLoader.load('./particles/9.png');
const texture2 = textureLoader.load('./particles/8.png');
// 创建着色器材质
